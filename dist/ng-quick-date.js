    ...
    'ngQuickDateDefaults', '$filter', '$sce', function(ngQuickDateDefaults, $filter, $sce) {
      return {
        ...
        link: function(scope, element, attrs, ngModelCtrl) {
          var dateToString, datepickerClicked, datesAreEqual, datesAreEqualToMinute, debounce, getDaysInMonth, initialize, parseDateString, refreshView, setCalendarDate, setConfigOptions, setInputFieldValues, setupCalendarView, stringToDate, useTouch;
          useTouch = false;
          initialize = function() {
            var templateDate;
            setConfigOptions();
            ...
            if (scope.isTouchDevice) {
              useTouch = true;
            } else if (scope.detectTouchDevices && ('ontouchstart' in window)) {
              useTouch = true;
            }
          ...
          setupCalendarView = function() {
            var curDate, d, day, daysInMonth, i, j, numRows, offset, ref, row, selected, time, today, weeks;
          ...
          scope.isMouseDown = function(date) {
            if (!useTouch) {
              return scope.selectDate(date, true, true);
            }
          };
          scope.isClick = function(date, ev) {
            if (useTouch) {
              return scope.selectDate(date, true, true);
            } else {
          ...
          scope.selectDateFromInput = function(closeCalendar) {
            var err, error, tmpDate, tmpDateAndTime, tmpTime;
            if (closeCalendar == null) {
              closeCalendar = false;
            }
            try {
